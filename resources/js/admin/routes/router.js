...
const router = new VueRouter({
    ...
    routes: [
      ...
      { path: '/admin/blog-category',name: 'blog-category',component: BlogCategory,meta: { requiresAuth: true } },
      ...
      { path: '/forgot-password', name: 'forgotforgot-password',component: ForgotPassword },
