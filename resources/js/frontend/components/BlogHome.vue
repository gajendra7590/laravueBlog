			...
			<div class="h-2-3 h-sm-auto oflow-hidden">
				...
				<div class="pb-5 pr-5 pr-sm-0 float-left float-sm-none w-2-3 w-sm-100 h-100 h-sm-300x">
					<router-link :to="`/s/${homeTop1.blog_url}`" class="pos-relative h-100 dplay-block"> 
						<img :src="`/images/${ homeTop1.blog_image?homeTop1.blog_image:'default/blogDefault.jpg' }`" onerror="this.src=`/images/default/blogDefault.jpg`" class="img-bg bg-1 bg-grad-layer-6">
				...
				<div class="float-left float-sm-none w-1-3 w-sm-100 h-100 h-sm-600x"> 
					<div v-for="(t2,key) in homeTop2" v-bind:key="key" class="pl-5 pb-5 pl-sm-0 ptb-sm-5 pos-relative h-50">
						<router-link :to="`/s/${t2.blog_url}`" class="pos-relative h-100 dplay-block"> 
							<img :src="`/images/${ t2.blog_image?t2.blog_image:'default/blogDefault.jpg' }`" onerror="this.src=`/images/default/blogDefault.jpg`" class="img-bg bg-2 bg-grad-layer-6"> 
							<div class="abs-blr color-white p-20 bg-sm-color-7">
			...
			<div class="h-1-3 oflow-hidden">
				...
				<div v-for="(t3,key) in homeTop3" v-bind:key="key" class="pr-5 pr-sm-0 pt-5 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
					<router-link :to="`/s/${t3.blog_url}`" class="pos-relative h-100 dplay-block"> 
						<img :src="`/images/${ t3.blog_image?t3.blog_image:'default/blogDefault.jpg' }`" onerror="this.src=`/images/default/blogDefault.jpg`" class="img-bg bg-4 bg-grad-layer-6">
						 <div class="abs-blr color-white p-20 bg-sm-color-7">
            ...
            <div class="container">
              <div class="row"> 
                <div class="col-md-12 col-lg-8"> 
                  ...
                  <div class="row">   
                    <div v-for="(recent,key) in homeRecent" v-bind:key="key" class="col-sm-6"> 
                      <img :src="`/images/${ recent.blog_image?recent.blog_image:'default/blogDefault.jpg' }`" onerror="this.src=`/images/default/blogDefault.jpg`" alt="">
                      <h4 class="pt-20">
...
import SideBar from './common/PostSidebar';
    export default {
        ...
        methods:{  
            ...
            homeRecentBlog(){
                let _this = this; 
                this.$store.dispatch('homeRecentBlogs')
                .then(function(data){  
