...
<head> 
  ...
  <link href="{{ URL::asset('adminjscss/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
</head> 
    <body id="page-top">   
          <div id="app"> 
             @yield('content') 
          ...
          <!-- Custom scripts for all pages-->
          <script type="text/javascript" src="{{ URL::asset('adminjscss/vendor/datatables/jquery.dataTables.min.js') }}"></script>
          <script type="text/javascript" src="{{ URL::asset('adminjscss/vendor/datatables/dataTables.bootstrap4.min.js') }}"></script>
